...
// Sidebar görünürlüğü artık BURADAKİ değil, lib/auth/roles.ts'teki
// MODULE_TREE/canAccessModule üzerinden çözülüyor (pozisyon şablonu +
// kullanıcı override, bkz. Ayarlar > Yetkilendirme). Eski departman bazlı
// sidebar_gizli mekanizması (SIDEBAR_YETKI_OGELERI/SIDEBAR_GIZLI_VARSAYILAN_DEPARTMAN)
// 2026-09-20'de kaldırıldı.
