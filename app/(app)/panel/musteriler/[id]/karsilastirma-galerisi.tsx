...
import type { MusteriKarsilastirma } from "@/types/musteri-detay";
import { belgeSignedUrlAl } from "./actions";

const ASAMA_ETIKETLERI: Record<NonNullable<MusteriKarsilastirma["asama"]>, string> = {
  tedavi_oncesi: "Tedavi Öncesi",
  ara_kontrol: "Ara Kontrol",
  tedavi_sonrasi: "Tedavi Sonrası",
};

export function KarsilastirmaGalerisi({ kayitlar }: { kayitlar: MusteriKarsilastirma[] }) {
  ...
  const gruplar = new Map<string, MusteriKarsilastirma[]>();
