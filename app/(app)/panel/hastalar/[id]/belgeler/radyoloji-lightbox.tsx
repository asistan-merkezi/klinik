...
import { BELGE_TURU_ETIKETLERI } from "@/types/hasta-belge";
import { VUCUT_BOLGE_ETIKETLERI } from "@/lib/vucut-bolgeleri";
import type { HastaBelge } from "@/types/hasta-belge";
...
export function RadyolojiLightbox({ belge, onKapat }: { belge: HastaBelge; onKapat: () => void }) {
