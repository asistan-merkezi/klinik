...
import { hastaOlustur } from "./actions";
  ...
  return (
    <form action={formAction} className="flex flex-col gap-4">
      <p className="text-xs text-muted-foreground">
        Hızlı kayıt — sadece temel bilgiler. Adres, acil durum kişisi ve sağlık geçmişi hasta
        portalından veya Hasta Detay sayfasından sonra eklenebilir.
      </p>
      ...
      <Button type="submit" disabled={isPending} className="w-fit">
        {isPending ? "Kaydediliyor..." : "Hasta ekle"}
      </Button>
    </form>
  );
}
