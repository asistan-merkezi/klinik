...
export function OdemeFormu({
  ...
  const odemeAlAction = odemeAl.bind(null, musteriId);
  ...
  return (
    <form action={formAction} className="flex flex-col gap-5">
            ...
            <li key={index} className="flex items-center justify-between gap-2 py-2">
              ...
              <div className="flex items-center gap-2">
                {k.tur === "islem" ? (
                  ...
                  <span className="text-zinc-600 dark:text-zinc-400">1 adet</span>
                )}
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className={`text-sm ${kalan === 0 ? "text-emerald-600" : "text-amber-600"}`}>
